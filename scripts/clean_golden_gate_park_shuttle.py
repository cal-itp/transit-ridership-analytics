...
def rename_operator_columns(df: pd.DataFrame) -> pd.DataFrame:
    ...
    """
    RENAME_COLS_DICT = {"Day Type": "day_type", "Date": "date", "stop": "stop_name", "ridership": "avg_ridership"}
...
if __name__ == "__main__":
    ...
    raw_ggp_export.to_parquet(f"{RAW_GCS}{agency_name}/ridership_round1.parquet", filesystem=gcsfs.GCSFileSystem())
