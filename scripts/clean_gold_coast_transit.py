...
def ingest_gold_coast_transit(
    agency_name: str = "gold_coast_transit", sheet_name: str = "May_2025_Stop_Ridership"
) -> pd.DataFrame:
    """
...
if __name__ == "__main__":
    ...
    raw_gct_export.to_parquet(f"{RAW_GCS}{agency_name}/ridership_round1.parquet", filesystem=gcsfs.GCSFileSystem())
